...
const Page = () => {
  ...
  useEffect(() => {
    ...
    const bdescriptionParam = urlParams.get('bdescription');
    const pdescriptionParam = urlParams.get('pdescription');
    const urlParam = urlParams.get('url');
    const termsParam = urlParams.get('terms');

    if (nameParam && onameParam && emailParam && phoneParam && addressParam && rfundingParam && tfundingParam && bdescriptionParam && pdescriptionParam && urlParam && termsParam) {
      setName(nameParam);
      setOname(onameParam);
      setEmail(emailParam);
      setPhone(phoneParam);
      ...
      setBdescription(bdescriptionParam);
      setPdescription(pdescriptionParam);
      setUrl(urlParam);
      setTerms(termsParam);
    }
  }, []);
          ...
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <div className="lg:w-full w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              <div className="flex flex-wrap -mx-4 mb-4">
                <div className="lg:w-1/2 w-full px-4 mb-4 lg:mb-0">
                  <div className="border rounded-lg p-6 h-full bg-white">
                    <h2 className="text-lg title-font text-gray-500 tracking-widest"><i className="fas fa-info-circle"></i> Business</h2>
              ...
              <div className="border rounded-lg p-6 flex flex-wrap bg-white">
                <h2 className="text-lg title-font text-gray-500 tracking-widest mb-4"><i className="fas fa-user"></i> Owner Details</h2>
              ...
              <div className="border rounded-lg p-6 lg:w-4/5 mx-auto mb-4 bg-white">
                <h2 className="text-lg title-font text-gray-500 tracking-widest"><i className="fas fa-info-circle"></i> Business Details</h2>
                <h1 className="text-pink-600 text-2xl title-font font-medium mb-1"><i className="fas fa-briefcase"></i> Business Description</h1>
                <p className="leading-relaxed mb-4">{bdescription}</p>

                <div class="flex items-center">
                  <SlLocationPin className="text-pink-600 text-3xl mr-2" />
                  <h1 className="text-gray-900 text-xl title-font font-medium mb-1"> {address}</h1>
                </div>
                <br></br>
                <h1 className="text-gray-900 text-xl title-font font-medium"><span className="text-pink-600"><i className="fas fa-link"></i> Business Website URL:</span> <Link href={url} className="text-pink-600 underline">{url}</Link></h1>
              </div>
              <div className="border rounded-lg p-6 lg:w-4/5 mx-auto mb-4 bg-white">
                <h2 className="text-lg title-font text-gray-500 tracking-widest"><i className="fas fa-info-circle"></i> Product Details</h2>
                <h1 className="text-pink-600 text-2xl title-font font-medium mb-1"><i className="fas fa-box"></i> Description</h1>
                <p className="leading-relaxed">{pdescription}</p>
              </div>
              <div className="border rounded-lg p-6 lg:w-4/5 mx-auto mb-4 bg-white">
