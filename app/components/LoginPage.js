  ...
  <div class="container h-full p-10">
    <div class="flex h-full flex-wrap items-center justify-center text-neutral-800 dark:text-neutral-200">
      ...
      <div class="w-full lg:w-6/12">
        <div class="block rounded-lg bg-white shadow-lg dark:bg-black">
          <div class="px-4 md:px-0 md:mx-6 md:p-12">
          
            <div class="text-center">
              <Image class="mx-auto w-48" src="/images/InvestHUB_login.png" alt="logo" width={400} height={400}/>
...
<div class="text-right mt-2">
              ...
              <button class="bg-blue-500 hover:bg-white hover:border border-blue-500 hover:text-blue-500 text-white rounded-lg font-bold cursor-pointer px-6 py-2">
                Login
              </button>
              {error && (
            ...
            <div class="flex items-center justify-center mt-4">
              ...
              <Link href={"/registerr"} type="button" className="ml-5 inline-block rounded border-2 border-danger px-6 pb-[6px] pt-2 text-xs font-medium uppercase leading-normal text-danger transition duration-150 ease-in-out hover:border-danger-600 hover:bg-danger-50/50 hover:text-danger-600 focus:border-danger-600 focus:bg-danger-50/50 focus:text-danger-600 focus:outline-none focus:ring-0 active:border-danger-700 active:text-danger-700 dark:hover:bg-rose-950 dark:focus:bg-rose-950" data-twe-ripple-init data-twe-ripple-color="light">
                Register
              </Link>
            </div>
            <br></br>
      ...
      <div class="flex items-center rounded-b-lg lg:w-6/12 lg:rounded-e-lg lg:rounded-bl-none"
              ...
              <Image src="/images/login.jpg" width={600} height={600}/>
